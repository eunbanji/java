...
public class _05_Stream {
    public static void main(String[] args) {
        ...
        Stream<String> langListstream1 = langList.stream();
        ...
        // java라는 글자를 포함하는 언어
        Arrays.stream(langs).filter(y -> y.contains("java")).forEach(System.out::println);
        System.out.println("-------------------------");
        ...
        // 4글자 이하 언어 중에서 c라는 글자를 포함하는 언어가 하나라도 있는지 여부
