...
public class _04_operator4 {
    public static void main(String[] args) {
        ...
        System.out.println(김치찌개 || 계란말이 || 제육볶음); // 하나라도 true면 true (괜찮은 식당)
        ...
        System.out.println((5 > 3) || (3 < 1)); // 5는 3보다 크고 3은 1보다 작다. (true)
        System.out.println((5 < 3) || (3 < 1)); // 5는 3보다 작고 3은 1보다 작다. (false)
